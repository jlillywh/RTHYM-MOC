...
class SimResultsDict(_SimResultsRequired, total=False):
    ...
    pipe_profile_cavity_volume: dict[str, NDArray[np.float64]]
    pipe_profile_cavity_active: dict[str, NDArray[np.int_]]
...
class MOCSolver:
    ...
    def set_interpolation_mode(self, enable: bool) -> None: ...
    def get_interpolation_mode(self) -> bool: ...
    def set_max_segments_per_pipe(self, max_segments: int) -> None: ...
    def get_max_segments_per_pipe(self) -> int: ...
    def set_max_wave_speed_distortion(self, max_fraction: float) -> None: ...
