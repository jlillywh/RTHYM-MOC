...
DISTANCE_CASES = [
    pytest.param(300.0, 2.0, 135, 12, id="300ft"),
    pytest.param(600.0, 7.0, 145, 6, id="600ft"),
...
def test_air_valve_dominant_vessel_distance_sweep_improves_regional_damping(
    ...
    assert all(value <= 12 for value in ordered_total_cavitation), (
    ...
    assert max(ordered_total_negative[1:]) - min(ordered_total_negative[1:]) <= 30, (
